...
\begin{figure}
  ...
  \caption{
    ...
    The fixed point diagram for the model [@may77] associated to $f_{\text{May}}$ as a function of varying the parameter $\beta H$.
...
Fig. \ref{fig:tbd} provides a rough idea of the fixed point structure by plotting the bifurcation diagram obtained from varying $c_{XY}$ and fixing the other parameters.
...
These fixed points may be generated by running the ‘‘stable\_points.py’’ script in [@repo].
}
\begin{align*}
