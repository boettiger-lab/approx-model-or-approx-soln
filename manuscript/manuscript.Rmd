...
*1. Three species, one fishery:* in this first model, only $X$ is harvested, that is we fix $M_Y=M_Z=0$ and leave $M_X$ as a control variable.
...
## Old 3 species text (to be copy-pased)
