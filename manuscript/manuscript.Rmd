...
py <- ppo_df |>
  ...
  geom_point() +
  theme(aspect.ratio = 1/1) +
  stat_function(fun = opt_escapement_harvest, col = 'deeppink', size = 0.8) + 
  stat_function(fun = msy_harvest, col = 'seagreen2', size = 0.8)
...
escxy <- ppo_df |>
  ...
  geom_point() +
  theme(aspect.ratio = 1/1) +
  stat_function(fun = opt_escapement_escapement, col = 'deeppink', size = 0.8)
