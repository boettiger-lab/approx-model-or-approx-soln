...
py <- ppo_df |>
  ...
  geom_point() +
  theme(aspect.ratio = 1/1) +
  stat_function(fun = opt_escapement_harvest, col = 'deeppink') + 
  stat_function(fun = msy_harvest, col = 'sienna4')
...
escxy <- ppo_df |>
  ...
  geom_point() +
  theme(aspect.ratio = 1/1) +
  stat_function(fun = opt_escapement_escapement, col = 'deeppink')
