...
# Appendix A: collected time series data


# Appendix B: variations on MSY

Here we show the performance of some variations of the MSY constant mortality policy.

First, consider constant mortality policies with a fraction $\alpha$ of the MSY mortality rate (in the main text we focused on $\alpha=0.8$).
