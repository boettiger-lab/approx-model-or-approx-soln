...
This time series is representative of the patterns observed in the data (see App. A).
...
(In App. B we discuss and evaluate other policies using a fixed-percentage of the MSY mortality rate.)
...
This anti-correlation is, furthermore, observed in the time series plots (see Fig. \ref{fig:timeseries} and App. A).
