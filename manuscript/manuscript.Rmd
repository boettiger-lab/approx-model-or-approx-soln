...
As seen in Fig. \ref{fig:conceptual-v2}, we consider four different models of the ecosystem with which the fishery interacts, each of this is called an *environment*, alluding to the environment in an RL setting.
