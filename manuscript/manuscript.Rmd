...
(Note that there are approaches to perform model-based reinforcement learning. 
While we will not focus on these in this paper they are surveyed in, e.g., [@moerland2023model; @polydoros2017survey].)
