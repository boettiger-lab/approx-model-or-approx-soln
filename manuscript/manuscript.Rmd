...
#| We compare two approaches here. 
...
#| The second (Harvest $B_{\mathrm{ii}}$) is based on RL.
#| Here, the policy function is expressed as a neural network and the algorithm uses a variant of \emph{gradient ascent} (namely, \emph{Proximal Policy Optimizaton (PPO)}) to optimize this network.
