...
As mentioned, discretising time allows a simplification of the possibly seasonal mating behavioral patterns of the species involved. 
...
```{r}
#| label: ephistograms
#| fig.cap: "Hisotgrams of episode lengths and rewards for the four different management strategies considered. Only the first 50 evaluation episodes (from a total of 100) were included, for ease of visualization."
#| out.width: "6in"
esc_len <- esc_ends %>%
  filter(rep<50) %>%
  ggplot(
