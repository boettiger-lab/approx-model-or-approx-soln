...
Training and evaluating management strategies was done by simulating *episodes.* 
...
This is likely due to experience of near-extinctions early on in the training process---where, given an impending extinction, it is more rewardful to fish intensively. 
...
The aforementioned Figure summarizes the statistics of 100 parameter perturbations so that we may expect perturbations of up to 60% (i.e. three sigmas) in the parameter values to appear in these statistics.
