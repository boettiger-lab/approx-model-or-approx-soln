...
#| The results plotted are the average reward obtained by the strategy over 100 episodes, and the fraction of those episodes which do not end with a near-extinction event.
...
*Model 4:* Here, the performance gap between DRL and CEsc is broadened, and the gap between DRL and CMort is maintained.
