...
For the sake of clarity, we will present here only the class of POMDPs which are relevant to our work: fully observed POMDPs with trivial emission function (FMDPs for short).
