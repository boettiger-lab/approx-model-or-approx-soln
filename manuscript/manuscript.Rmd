...
\begin{table}
  \begin{center}
    \begin{tabular}{|l|c|c|c|c|}
      ...
      3 species, 2 fishery, time-varying parameters & \eqref{eq:3d model} & 3 & $X$ and $Y$ & No \\
      \hline
    \end{tabular}
