...
Similarly, *curriculum learning* [@curriculum-learning] or *open-ended learning* [@open-ended] could be incorporated to deal with phenomena such as parametric noise, parametric drift, and, more generally, for deriving generally well-performing agents *vis-à-vis* uncertainties in the system's dynamics. <!-- ML: Could also use LSTMs for parametric drift. Might be better to use a different selling point for curriculum learning like if you want to have a bit more generalizability in your RL agent. -->
